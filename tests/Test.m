...
vx = 5; vy=3; vz=2;
%% reference outputs
a2e = 186.278; a2n = 286.842; a2u = 939.693; % aer2enu
...
assert_allclose([e,n,u], [a2e,a2n,a2u], [], 1e-6)
...
assert_allclose([x,y,z], [a2x,a2y,a2z], [],0.001)

[lat2, lon2, alt2] = ecef2geodetic(g2x, g2y, g2z,ell);
