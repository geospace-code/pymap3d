...
Because of their present lack of Fortran 2008 compliance, ``ifort`` R2019, ``pgf90`` R2017 and ``flang`` 5.0 give spurious runtime errors, even when trying to accomodate them, they flail on optional function arguments and ``error stop``!
Thus we currently in general recommend ``gfortran``.
