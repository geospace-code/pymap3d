...
from numpy import radians, sin, tan, exp, arctan, log, degrees, sqrt, pi
...
def geodetic2isometric(lat: float, ell: Ellipsoid = None, deg: bool = True) -> float:
    """
...
def isometric2geodetic(isolat, ell: Ellipsoid = None, deg: bool = True) -> float:
    '''
...
def geodetic2rectifying(lat, ell: Ellipsoid = None, deg: bool = True) -> float:
    '''
...
def rectifying2geodetic(reclat, ell: Ellipsoid = None, deg: bool = True) -> float:
    '''
...
def geodetic2conformal(lat, ell: Ellipsoid = None, deg: bool = True) -> float:
    '''
...
def conformal2geodetic(cnflat, ell: Ellipsoid = None, deg: bool = True) -> float:
    '''
...
def geodetic2parametric(lat, ell: Ellipsoid = None, deg: bool = True) -> float:
    '''
...
def parametric2geodetic(parlat, ell: Ellipsoid = None, deg: bool = True) -> float:
    '''
...
def geodetic2geocentric(lat, ell: Ellipsoid = None, deg: bool = True) -> float:
    '''
...
def geocentric2geodetic(cenlat, ell: Ellipsoid = None, deg: bool = True) -> float:
    '''
...
def geodetic2authalic(lat, ell: Ellipsoid = None, deg: bool = True) -> float:
    '''
...
def authalic2geodetic(autlat, ell: Ellipsoid = None, deg: bool = True) -> float:
    '''
